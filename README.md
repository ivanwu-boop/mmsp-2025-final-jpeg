...
本次實驗內容相當複雜，從影像格式處理、頻域轉換到量化與熵編碼，每一個步驟都需要仔細理解其背後的原理與資料流向。在實作過程中，曾多次因細節錯誤導致結果異常，透過與同學反覆討論與檢查整體流程，才逐漸釐清問題並修正實作方向。

最終能夠完成整個 JPEG-like 壓縮與解碼流程，並成功重建影像，對於課程中所學的訊號處理與影像壓縮概念有更具體且深刻的理解，也帶來相當大的成就感。
